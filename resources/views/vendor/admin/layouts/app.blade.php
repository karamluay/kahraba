...
<head>
    ...
    <title> Agrematco -  {{ $title ?? ('Home') }}</title>
            ...
            <div class="navbar-header" data-logobg="skin6">
                ...
                <div class="navbar-brand">
                    <a href="@route(getRouteName().'.home')">
                        <span class="logo-text">Agrematco</span>
                    </a>
                </div>
                <!-- End Logo -->
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle pl-md-3 position-relative" href="javascript:void(0)"
                               ...
                               aria-expanded="false">
                                ...
                                <span class="badge badge-primary notify-no round

Mohmmad Moatz, [06.07.21 04:44]
ed-circle">{{ \EasyPanel\Models\Todo::where('user_id', auth()->user()->id)->where('checked', false)->count() }}</span>
                            </a>
